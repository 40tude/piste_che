...
Remarque : aujourd'hui on ne travaille QUE avec le domaine de Serre Chevalier. Faut être malin et anticiper le fait que plus tard, on utilisera l'outil resort_generator pour générer le json de Chamonix ou de Montgenèvre.
