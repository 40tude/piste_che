...
- [x] Problème aux points d'arrivée et de départ qui sont pas toujours les plus proche sur les piste
- [x] Vérifier les distances annoncées dans l'itinéraire (Pontillas 50m?)
- [x] Faire mieux ressortir l'itinéraire
- [x] Les flèches dans la bonne direction
- [x] Ne pas masquer complètement les pistes hor itinéraire faut les dimmer (à 20% ?). Voir map.rs line 119
- [x] Probleme de bouton bleu invisible sur Edge téléphoen => le remonter. Voir style/main.css line 342 10rem
